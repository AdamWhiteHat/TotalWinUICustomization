...
namespace TotalWinUICustomization.Types
{
    ...
    {
        public static Dictionary<WindowsUiElements, string> EnumToRegistryKey = new Dictionary<WindowsUiElements, string>()
        {
        ...
        public static Dictionary<WindowsUiElements, bool> EnumToIsFontDictionary = new Dictionary<WindowsUiElements, bool>()
        {
            ...
            { WindowsUiElements.GreyText,true },
            ...
            { WindowsUiElements.HotTrackingColor,true },
            { WindowsUiElements.MenuBar,false },
            { WindowsUiElements.AppWorkspace,false }
        };

        public static Dictionary<WindowsUiElements, WindowsUiElements?> EnumToCompanionEnum = new Dictionary<WindowsUiElements, WindowsUiElements?>()
        {
            ...
            { WindowsUiElements.GreyText,null },
            { WindowsUiElements.DesktopBackground,null },
